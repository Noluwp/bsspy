document.addEventListener('DOMContentLoaded', () => {
    ...
    const brawlersList = [
        ...
        "Гэйл", "Вольт", "Колетт", "Лу", "Гавс", "Белль", "Базз", "Эш", "Лола", "Фэнг", "Ева", "Джанет", 
        "Отис", "Сэм", "Бастер", "Мэнди", "R-T", "Мэйси", "Корделиус", "Перл", "Ларри и Лори", "Лили", "Берри", "Клэнси", "Мо", "Кендзи", "Джуджу", "Шейд"
    ];
